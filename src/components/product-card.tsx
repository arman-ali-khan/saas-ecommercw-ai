...
import { ShoppingBag, Star, X, Plus, Minus, CheckCircle2 } from 'lucide-react';
...
export default function ProductCard({ product, flashDeal }: ProductCardProps) {
  ...
  return (
    ...
    {/* Quick View Dialog using Raw Tailwind styled ShadCN component */}
    <Dialog open={isQuickViewOpen} onOpenChange={setIsQuickViewOpen}>
        <DialogContent className="sm:max-w-xl rounded-[2.5rem] p-0 overflow-hidden border-2 border-primary/10 shadow-2xl">
