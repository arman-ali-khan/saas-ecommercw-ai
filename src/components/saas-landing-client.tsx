...
const landingTranslations = {
  bn: {
    ...
    heroDesc: "দোকানবিডি-এর মাধ্যমে কয়েক মিনিটের মধ্যেই শুরু করুন আপনার নিজস্ব ই-কমার্স প্ল্যাটফর্ম। এআই-চালিত টুলস এবং কাস্টমাইজযোগ্য ডিজাইন নিয়ে আজই আপনার ব্র্যান্ড চালু করুন।",
    ...
    ctaDesc: "হাজার হাজার উদ্যোক্তার সাথে যোগ দিন যারা দোকানবিডি ব্যবহার করে তাদের ব্র্যান্ডকে সফলভাবে গড়ে তুলছেন।",
...
export default function SaasLandingClient({ plans, features, reviews, showcaseItems, settings, sections }: SaasLandingClientProps) {
  ...
  return (
    <div id="root-main" className="selection:bg-primary/30">
