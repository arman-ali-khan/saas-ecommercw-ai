...
const BRAND_PALETTES = [
    ...
    { name: 'Shein', colors: { theme_primary: '0 0% 0%', theme_primary_foreground: '0 0% 100%', theme_secondary: '0 0% 90%', theme_secondary_foreground: '0 0% 0%', theme_accent: '0 0% 60%', theme_accent_foreground: '0 0% 100%', theme_background: '0 0% 100%', theme_foreground: '0 0% 0%', theme_card: '0 0% 100%', theme_card_foreground: '0 0% 0%', theme_muted: '0 0% 96%', theme_muted_foreground: '0 0% 45%', theme_border: '0 0% 92%', theme_input: '0 0% 92%', theme_destructive: '0 84% 60%' } },
    ...
    { name: 'Shajgoj', colors: { theme_primary: '330 81% 60%', theme_primary_foreground: '0 0% 100%', theme_secondary: '330 81% 20%', theme_secondary_foreground: '0 0% 100%', theme_accent: '330 81% 80%', theme_accent_foreground: '330 81% 20%', theme_background: '0 0% 100%', theme_foreground: '330 81% 10%', theme_card: '330 81% 98%', theme_card_foreground: '330 81% 10%', theme_muted: '330 81% 95%', theme_muted_foreground: '330 81% 40%', theme_border: '330 81% 90%', theme_input: '330 81% 90%', theme_destructive: '0 100% 40%' } },
    ...
    <div className="space-y-6 pb-20">
      ...
      <Card className="border-2">
        <CardHeader className="bg-muted/30">
            <CardTitle className="flex items-center gap-2"><Palette className="h-5 w-5 text-primary"/> Premium Palettes (Light)</CardTitle>
            <CardDescription>Popular eCommerce branding styles. Customers can still toggle Dark Mode themselves.</CardDescription>
        </CardHeader>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          <Card className="border-2">
            <CardHeader className="bg-muted/30">
                ...
                <CardDescription>Set the starting look for new visitors.</CardDescription>
            </CardHeader>
            <CardContent className="pt-6">
                <FormField control={form.control} name="theme_mode" render={({ field }) => (
                    <FormItem className="flex flex-row items-center justify-between rounded-xl border p-4 bg-muted/20">
                        <div className="space-y-0.5">
                            ...
                            <FormDescription>Toggle to set Dark Mode as the default.</FormDescription>
                        </div>
                        <FormControl>
          ...
          <Card className="border-2">
            <CardHeader className="bg-muted/30"><CardTitle className="flex items-center gap-2"><Palette className="h-5 w-5 text-primary"/> Custom Colors</CardTitle></CardHeader>
            <CardContent className="pt-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <FormField control={form.control} name="theme_destructive" render={({ field }) => <ColorInput field={field} label="Danger Color" />} />
                </div>
